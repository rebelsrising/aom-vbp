...
void main() {
	...
	// RM X Setup.
	rmxInit("Tundra (ESO)", false, false, false);
	...
	if (rmRandFloat(0, 1) < 0.8) rmAddObjectDefItem(closeChickensID, "goat", rmRandInt(6, 8), 5.0);
	...
	else if (huntableNumber < 0.3) rmAddObjectDefItem(closeHuntableID, "Elk", rmRandInt(5, 6), 2.0);
	else if (huntableNumber < 0.6) rmAddObjectDefItem(closeHuntableID, "Aurochs", 2, 2.0);
	else if (huntableNumber < 0.9) rmAddObjectDefItem(closeHuntableID, "Aurochs", 3, 2.0);
	else if (huntableNumber < 1.0) rmAddObjectDefItem(closeHuntableID, "Aurochs", 4, 2.0);
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(mediumDeerID, "Elk", numHuntable, 4.0);
	else rmAddObjectDefItem(mediumDeerID, "Elk", numHuntable, 4.0);
	...
	if (predatorSpecies < 0.5) rmAddObjectDefItem(farPredatorID, "Polar Bear", 1, 4.0);
	else rmAddObjectDefItem(farPredatorID, "Wolf Arctic 2", 2, 4.0);
	...
	else if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntableID, "Elk", rmRandInt(4, 6), 2.0);
	else if (bonusChance < 0.9) rmAddObjectDefItem(bonusHuntableID, "Aurochs", rmRandInt(2, 3), 2.0);
	else rmAddObjectDefItem(bonusHuntableID, "Caribou", rmRandInt(4, 7), 3.0);
	...
	if (bonusChance < 0.1) rmAddObjectDefItem(bonusHuntable2ID, "Aurochs", 3, 2.0);
	else if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntable2ID, "Aurochs", 2, 2.0);
	else if (bonusChance < 0.9) rmAddObjectDefItem(bonusHuntable2ID, "Aurochs", 2, 2.0);
	else rmAddObjectDefItem(bonusHuntable2ID, "Aurochs", 3, 4.0);
	...
	// Settlements.
	id = rmAddFairLoc("Settlement", false, true, 50, 80, 60, 10);
	/* forward inside */
...
*/
	...
	// Monkeys
	if (rmRandFloat(0, 1) < 0.5) rmPlaceObjectDefPerPlayer(farMonkeyID, false, 3);
...
*/
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(deerID, "Elk", rmRandInt(3, 4), 1.0);
	else rmAddObjectDefItem(deerID, "Caribou", 3, 0.0);
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(deer2ID, "Aurochs", 1, 1.0);
	else rmAddObjectDefItem(deer2ID, "Elk", 1, 0.0);
