...
void main() {
	...
	// RM X Setup.
	rmxInit("Land Unknown (ESO)", false, false, false);
	...
	if (resourceChance < 0.1) {
		...
		for (i = 1; < cNumberPlayers) {
			if (rmRandFloat(0, 1) < 0.33) rmAddPlayerResource(i, "Food", 50);
			else if (rmRandFloat(0, 1) < 0.5) rmAddPlayerResource(i, "Wood", 50);
			else rmAddPlayerResource(i, "Gold", 50);
		}
	}
	else if (resourceChance < 0.26) {
		for (i = 1; < cNumberPlayers) {
			if (rmRandFloat(0, 1) < 0.33) rmAddPlayerResource(i, "Food", 100);
			else if (rmRandFloat(0, 1) < 0.5) rmAddPlayerResource(i, "Wood", 100);
			else rmAddPlayerResource(i, "Gold", 100);
		}
	}
	...
	if (terrainChance == 0) rmEchoInfo("terrain chance " + terrainChance + " Greek");
	else if (terrainChance == 1) rmEchoInfo("terrain chance " + terrainChance + " Egyptian");
	else rmEchoInfo("terrain chance " + terrainChance + " Norse");
	...
	if (terrainChance == 0) {
		...
		/* Egyptian ocean */
		{
			if (rmRandFloat(0, 1) < 0.25) savannah = 1;
			rmSetSeaType("red sea");
			rmTerrainInitialize("water");
			fishExist = 1;
		}
		else {
			if (rmRandFloat(0, 1) < 0.75) rmTerrainInitialize("SandB");
			/* Egyptian land */
			else {
	...
	if (rmRandFloat(0, 1) < 0.75) {
		if (terrainChance == 0) rmAddObjectDefItem(closePigsID, "pig", rmRandInt(1, 3), 2.0);
		else if (terrainChance == 1) rmAddObjectDefItem(closePigsID, "goat", rmRandInt(1, 3), 2.0);
		else if (terrainChance == 2) rmAddObjectDefItem(closePigsID, "cow", rmRandInt(1, 3), 2.0);
	}
	else {
		if (terrainChance == 0) rmAddObjectDefItem(closePigsID, "pig", rmRandInt(4, 5), 2.0);
		else if (terrainChance == 1) rmAddObjectDefItem(closePigsID, "goat", rmRandInt(4, 5), 2.0);
		else if (terrainChance == 2) rmAddObjectDefItem(closePigsID, "cow", rmRandInt(4, 5), 2.0);
	}
	...
	if (terrainChance == 0) {
		if (huntSpeciesChance < 0.5) rmAddObjectDefItem(closeBoarID, "boar", rmRandInt(1, 3), 4.0);
		else rmAddObjectDefItem(closeBoarID, "deer", rmRandInt(4, 6), 4.0);
	}
	else if (terrainChance == 1) {
		if (huntSpeciesChance < 0.2) rmAddObjectDefItem(closeBoarID, "hippo", rmRandInt(1, 2), 4.0);
		else if (huntSpeciesChance < 0.4) rmAddObjectDefItem(closeBoarID, "zebra", rmRandInt(4, 12), 5.0);
		else if (huntSpeciesChance < 0.6) rmAddObjectDefItem(closeBoarID, "giraffe", rmRandInt(4, 8), 4.0);
		else if (huntSpeciesChance < 0.8) rmAddObjectDefItem(closeBoarID, "elephant", rmRandInt(1, 2), 4.0);
		else rmAddObjectDefItem(closeBoarID, "rhinocerous", rmRandInt(1, 3), 4.0);
	}
	else {
		if (huntSpeciesChance < 0.33) rmAddObjectDefItem(closeBoarID, "boar", rmRandInt(2, 6), 4.0);
		else if (huntSpeciesChance < 0.66) rmAddObjectDefItem(closeBoarID, "caribou", rmRandInt(4, 8), 4.0);
		else rmAddObjectDefItem(closeBoarID, "aurochs", rmRandInt(2, 6), 4.0);
	}
	...
	if (terrainChance == 0) {
		if (rmRandFloat(0, 1) < 0.7) rmAddObjectDefItem(stragglerTreeID, "oak tree", 1, 0.0);
		else if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(stragglerTreeID, "savannah tree", 1, 0.0);
		else rmAddObjectDefItem(stragglerTreeID, "oak autumn", 1, 0.0);
	}
	else if (terrainChance == 1) {
		if (rmRandFloat(0, 1) < 0.2) rmAddObjectDefItem(stragglerTreeID, "savannah tree", 1, 0.0);
		else rmAddObjectDefItem(stragglerTreeID, "palm", 1, 0.0);
	}
	else rmAddObjectDefItem(stragglerTreeID, "pine", 1, 0.0);
	...
	if (terrainChance == 0) rmAddObjectDefItem(mediumPigsID, "pig", rmRandInt(1, 3), 2.0);
	else if (terrainChance == 1) rmAddObjectDefItem(mediumPigsID, "goat", rmRandInt(1, 3), 2.0);
	else if (terrainChance == 2) rmAddObjectDefItem(mediumPigsID, "cow", rmRandInt(1, 3), 2.0);
	...
	rmAddObjectDefConstraint(mediumPigsID, objForestConstraint);
	...
	if (terrainChance == 0) rmAddObjectDefItem(playerFishID, "fish - mahi", 3, 10.0);
	else if (terrainChance == 1) rmAddObjectDefItem(playerFishID, "fish - perch", 3, 10.0);
	else if (terrainChance == 2) rmAddObjectDefItem(playerFishID, "fish - salmon", 3, 10.0);
	...
	if (rmRandFloat(0, 1) < 0.9) rmAddObjectDefItem(farGoldID, "Gold mine", 1, 0.0);
	else rmAddObjectDefItem(farGoldID, "Gold mine", 2, 6.0);
	...
	if (terrainChance == 0) rmAddObjectDefItem(farPigsID, "pig", rmRandInt(1, 3), 2.0);
	else if (terrainChance == 1) rmAddObjectDefItem(farPigsID, "goat", rmRandInt(1, 3), 2.0);
	else if (terrainChance == 2) rmAddObjectDefItem(farPigsID, "cow", rmRandInt(1, 3), 2.0);
	...
	rmAddObjectDefConstraint(farPigsID, objForestConstraint);
	rmAddObjectDefConstraint(farPigsID, farStartingSettleConstraint);

	// pick lions or bears as predators
	// avoid TCs
	int farPredatorID = rmCreateObjectDef("far predator");
	if (terrainChance == 1) if (rmRandFloat(0, 1) < 0.50) rmAddObjectDefItem(farPredatorID, "lion", rmRandInt(1, 2), 4.0);
	else rmAddObjectDefItem(farPredatorID, "hyena", rmRandInt(2, 3), 4.0);
	else if (terrainChance == 0) if (rmRandFloat(0, 1) < 0.33) rmAddObjectDefItem(farPredatorID, "lion", rmRandInt(1, 2), 4.0);
	else if (rmRandFloat(0, 1) < 0.50) rmAddObjectDefItem(farPredatorID, "wolf", rmRandInt(2, 3), 4.0);
	else rmAddObjectDefItem(farPredatorID, "bear", rmRandInt(1, 2), 4.0);
	else if (rmRandFloat(0, 1) < 0.33) rmAddObjectDefItem(farPredatorID, "bear", rmRandInt(1, 2), 4.0);
	else if (rmRandFloat(0, 1) < 0.50) rmAddObjectDefItem(farPredatorID, "polar bear", rmRandInt(1, 2), 4.0);
	else rmAddObjectDefItem(farPredatorID, "wolf", rmRandInt(2, 3), 4.0);
	...
	rmAddObjectDefConstraint(farPredatorID, objForestConstraint);
	...
	if (terrainChance == 0) {
		if (huntSpeciesChance < 0.5) rmAddObjectDefItem(bonusHuntableID, "boar", rmRandInt(2, 4), 4.0);
		else rmAddObjectDefItem(bonusHuntableID, "deer", rmRandInt(6, 8), 4.0);
	}
	else if (terrainChance == 1) {
		if (huntSpeciesChance < 0.2) rmAddObjectDefItem(bonusHuntableID, "gazelle", rmRandInt(6, 8), 4.0);
		else if (huntSpeciesChance < 0.4) rmAddObjectDefItem(bonusHuntableID, "zebra", rmRandInt(4, 8), 4.0);
		else if (huntSpeciesChance < 0.6) rmAddObjectDefItem(bonusHuntableID, "giraffe", rmRandInt(3, 6), 4.0);
		else if (huntSpeciesChance < 0.8) rmAddObjectDefItem(bonusHuntableID, "elephant", rmRandInt(1, 2), 4.0);
		else rmAddObjectDefItem(bonusHuntableID, "rhinocerous", rmRandInt(1, 3), 4.0);
	}
	else {
		if (huntSpeciesChance < 0.5) rmAddObjectDefItem(bonusHuntableID, "boar", rmRandInt(2, 4), 4.0);
		else rmAddObjectDefItem(bonusHuntableID, "caribou", rmRandInt(4, 8), 4.0);
	}
	...
	if (terrainChance == 0) {
		if (huntSpeciesChance < 0.5) rmAddObjectDefItem(bonusHuntable2ID, "boar", rmRandInt(2, 4), 4.0);
		else rmAddObjectDefItem(bonusHuntable2ID, "deer", rmRandInt(4, 6), 4.0);
	}
	else if (terrainChance == 1) {
		if (huntSpeciesChance < 0.2) rmAddObjectDefItem(bonusHuntable2ID, "gazelle", rmRandInt(6, 8), 4.0);
		else if (huntSpeciesChance < 0.4) rmAddObjectDefItem(bonusHuntable2ID, "zebra", rmRandInt(4, 8), 4.0);
		else if (huntSpeciesChance < 0.6) rmAddObjectDefItem(bonusHuntable2ID, "giraffe", rmRandInt(4, 8), 4.0);
		else if (huntSpeciesChance < 0.8) rmAddObjectDefItem(bonusHuntable2ID, "elephant", rmRandInt(1, 2), 4.0);
		else rmAddObjectDefItem(bonusHuntable2ID, "rhinocerous", rmRandInt(1, 3), 4.0);
	}
	else {
		if (huntSpeciesChance < 0.5) rmAddObjectDefItem(bonusHuntable2ID, "boar", rmRandInt(2, 4), 4.0);
		else rmAddObjectDefItem(bonusHuntable2ID, "caribou", rmRandInt(4, 8), 4.0);
	}
	...
	if (terrainChance == 0) {
		if (rmRandFloat(0, 1) < 0.7) rmAddObjectDefItem(randomTreeID, "oak tree", 1, 0.0);
		else if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(randomTreeID, "savannah tree", 1, 0.0);
		else rmAddObjectDefItem(randomTreeID, "oak autumn", 1, 0.0);
	}
	else if (terrainChance == 1) {
		if (rmRandFloat(0, 1) < 0.2) rmAddObjectDefItem(randomTreeID, "savannah tree", 1, 0.0);
		else rmAddObjectDefItem(randomTreeID, "palm", 1, 0.0);
	}
	else {
		if (rmRandFloat(0, 1) < 0.2) rmAddObjectDefItem(randomTreeID, "pine snow", 1, 0.0);
		else rmAddObjectDefItem(randomTreeID, "pine", 1, 0.0);
	}
	...
	int teamLands = 0;
	/* never mess with team lands, since we don't want islands */
	...
	/* FIFTH STEP determine if players on a team are together or not */
	...
	/* forest */
	{
		rmSetAreaSize(centerID, 0.05, 0.08);
		if (terrainChance == 0) {
			if (rmRandFloat(0, 1) < 0.2) rmSetAreaForestType(centerID, "savannah forest");
			else rmSetAreaForestType(centerID, "oak forest");
		}
		else if (terrainChance == 2) rmSetAreaForestType(centerID, "mixed pine forest");
		else {
			if (rmRandFloat(0, 1) < 0.2) rmSetAreaForestType(centerID, "savannah forest");
			else rmSetAreaForestType(centerID, "mixed palm forest");
		}
		rmAddAreaToClass(centerID, rmClassID("center"));
		rmSetAreaLocation(centerID, 0.5, 0.5);
	...
	else if (centerType == 0) rmEchoInfo("no center");
	...
	for (i = 1; < cNumberPlayers) {
		...
		// else if(baseTerrainChance < 0.3)   /* ocean */
		else rmSetAreaSize(id, 0.9 * playerFraction, 1.1 * playerFraction);
		...
		if (terrainChance == 0) rmSetAreaTerrainType(id, "GrassDirt25");
		else if (terrainChance == 2) {
	...
	for (i = 1; < cNumberPlayers) {
		...
		if (terrainChance == 0) rmSetAreaTerrainType(playerPatch, "GrassDirt50");
		else if (terrainChance == 1) {
			if (savannah == 1) {
	...
	for (i = 1; < cNumberPlayers * 8) {
		...
		if (terrainChance == 1) {
			if (savannah == 1) rmSetAreaTerrainType(largePatch, "SavannahB");
			else rmSetAreaTerrainType(largePatch, "SandD");
		}
		else if (terrainChance == 0) rmSetAreaTerrainType(largePatch, "GrassDirt25");
		else if (terrainChance == 2) rmSetAreaTerrainType(largePatch, "SnowGrass25");
	...
	for (i = 1; < cNumberPlayers * 8) {
		...
		if (terrainChance == 0) rmSetAreaTerrainType(smallPatch, "GrassB");
		else if (terrainChance == 1) {
			if (savannah == 1) rmSetAreaTerrainType(smallPatch, "SandB");
			else rmSetAreaTerrainType(smallPatch, "SandB");
		}
		else if (terrainChance == 2) rmSetAreaTerrainType(smallPatch, "SnowB");
	...
	if (fishExist == 1) {
		...
		if (terrainChance == 0) rmAddObjectDefItem(fishID, "fish - mahi", 3, 9.0);
		else if (terrainChance == 1) rmAddObjectDefItem(fishID, "fish - perch", 3, 9.0);
		else if (terrainChance == 2) rmAddObjectDefItem(fishID, "fish - salmon", 3, 9.0);
		...
		if (rmRandFloat(0, 1) < 0.33) rmAddObjectDefItem(sharkID, "shark", 1, 0.0);
		else if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(sharkID, "whale", 1, 0.0);
		else rmAddObjectDefItem(sharkID, "orca", 1, 0.0);
	...
	if (cNumberNonGaiaPlayers < 5) {
		if (rmRandFloat(0.0, 1.0) < 0.1) {
			id = rmAddFairLoc("Settlement", true, false, 70, 150, 50, 10);
			rmAddFairLocConstraint(id, avoidImpassableLand);
		}
	}
	...
	// Chickens or berries.
	for (i = 1; < cNumberPlayers) {
		if (rmRandFloat(0.0, 1.0) < 0.5) rmPlaceObjectDefAtLoc(closeChickensID, 0, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));
		else rmPlaceObjectDefAtLoc(closeBerriesID, 0, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));
	}
	...
	if (bigForestExist == 1) {
		if (bigChance > 0.6) {
			...
			{
				if (diverseForest == 0) {
					if (forestSpecies < 0.7) rmSetAreaForestType(bigAForestID, "oak forest");
					else if (forestSpecies < 0.90) rmSetAreaForestType(bigAForestID, "autumn oak forest");
					else rmSetAreaForestType(bigAForestID, "savannah forest");
				}
				else if (diverseForest == 1) {
					if (diverseForestType == 0) {
						if (rmRandFloat(0, 1) < 0.8) rmSetAreaForestType(bigAForestID, "oak forest");
						else rmSetAreaForestType(bigAForestID, "savannah forest");
					}
					else {
						if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(bigAForestID, "oak forest");
						else rmSetAreaForestType(bigAForestID, "autumn oak forest");
					}
				}
			}
			else if (terrainChance == 2)
			...
			{
				if (diverseForest == 0) {
					if (forestSpecies < 0.7) rmSetAreaForestType(bigAForestID, "pine forest");
					else if (forestSpecies < 0.85) rmSetAreaForestType(bigAForestID, "minxed oak forest");
					else rmSetAreaForestType(bigAForestID, "mixed pine forest");
				}
				else if (diverseForest == 1) {
					if (diverseForestType == 0) {
						if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(bigAForestID, "pine forest");
						else rmSetAreaForestType(bigAForestID, "mixed pine forest");
					}
					else {
						if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(bigAForestID, "snow pine forest");
						else rmSetAreaForestType(bigAForestID, "mixed pine forest");
					}
				}
			}
			...
			{
				if (diverseForest == 0) {
					if (forestSpecies < 0.7) rmSetAreaForestType(bigAForestID, "palm forest");
					else if (forestSpecies < 0.75) rmSetAreaForestType(bigAForestID, "savannah forest");
					else rmSetAreaForestType(bigAForestID, "mixed palm forest");
				}
				else if (diverseForest == 1) {
					if (diverseForestType == 0) {
						if (rmRandFloat(0, 1) < 0.8) rmSetAreaForestType(bigAForestID, "palm forest");
						else rmSetAreaForestType(bigAForestID, "savannah forest");
					}
					else {
						if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(bigAForestID, "palm forest");
						else rmSetAreaForestType(bigAForestID, "mixed palm forest");
					}
				}
			}
			...
			if (rmRandFloat(0, 1) < 0.80) rmAddAreaConstraint(bigAForestID, forestConstraint);
			else rmAddAreaConstraint(bigAForestID, wideForestConstraint);
			if (centerType == 2)
			/* center is ice */
			...
			if (terrainChance == 0) rmSetAreaCliffType(cliffID, "Greek");
			else if (terrainChance == 2) rmSetAreaCliffType(cliffID, "Norse");
			else rmSetAreaCliffType(cliffID, "Egyptian");
			...
			if (rmRandFloat(0, 1) < 0.5) rmSetAreaCliffEdge(cliffID, 1, 0.85, 0.2, 1.0, 2);
			else rmSetAreaCliffEdge(cliffID, 2, 0.40, 0.2, 1.0, 0);
	...
	// Medium things....
	// Gold
	if (rmRandFloat(0, 1) < 0.75) rmPlaceObjectDefPerPlayer(mediumGoldID, false);
	...
	// Far things.
	// Gold.
	if (rmRandFloat(0, 1) < 0.75) rmPlaceObjectDefPerPlayer(farGoldID, false, rmRandInt(2, 4));
	else if (rmRandFloat(0, 1) < 0.2) rmPlaceObjectDefPerPlayer(farGoldID, false, rmRandInt(5, 6));

	// Relics
	float relicNum = rmRandFloat(0, 1);
	if (relicNum < 0.8) rmPlaceObjectDefPerPlayer(relicID, false);
	else if (relicNum < 0.95) rmPlaceObjectDefPerPlayer(relicID, false, 2);
	else rmPlaceObjectDefPerPlayer(relicID, false, 4);

	// Hawks
	rmPlaceObjectDefPerPlayer(farhawkID, false, 2);

	// Pigs
	if (rmRandFloat(0, 1) < 0.90) rmPlaceObjectDefPerPlayer(farPigsID, false, rmRandInt(0, 2));
	else rmPlaceObjectDefPerPlayer(farPigsID, false, rmRandInt(8, 10));
	...
	// Berries
	if (rmRandFloat(0, 1) < 0.25) rmPlaceObjectDefAtLoc(farBerriesID, 0, 0.5, 0.5, cNumberNonGaiaPlayers);

	// Predators
	rmPlaceObjectDefPerPlayer(farPredatorID, false, 1);

	// Random trees.
	if (rmRandFloat(0, 1) < 0.9) rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 10 * cNumberNonGaiaPlayers);
	else rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 30 * cNumberNonGaiaPlayers);
	...
	for (i = 0; < forestCount) {
		...
		{
			if (diverseForest == 0) {
				if (forestSpecies < 0.7) rmSetAreaForestType(forestID, "oak forest");
				else if (forestSpecies < 0.90) rmSetAreaForestType(forestID, "autumn oak forest");
				else rmSetAreaForestType(forestID, "savannah forest");
			}
			else if (diverseForest == 1) {
				if (diverseForestType == 0) {
					if (rmRandFloat(0, 1) < 0.8) rmSetAreaForestType(forestID, "oak forest");
					else rmSetAreaForestType(forestID, "savannah forest");
				}
				else {
					if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(forestID, "oak forest");
					else rmSetAreaForestType(forestID, "autumn oak forest");
				}
			}
		}
		else if (terrainChance == 2)
		...
		{
			if (diverseForest == 0) {
				if (forestSpecies < 0.7) rmSetAreaForestType(forestID, "pine forest");
				else if (forestSpecies < 0.85) rmSetAreaForestType(forestID, "mixed oak forest");
				else rmSetAreaForestType(forestID, "mixed pine forest");
			}
			else if (diverseForest == 1) {
				if (diverseForestType == 0) {
					if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(forestID, "pine forest");
					else rmSetAreaForestType(forestID, "mixed pine forest");
				}
				else {
					if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(forestID, "snow pine forest");
					else rmSetAreaForestType(forestID, "mixed pine forest");
				}
			}
		}
		...
		{
			if (diverseForest == 0) {
				if (forestSpecies < 0.7) rmSetAreaForestType(forestID, "palm forest");
				else if (forestSpecies < 0.75) rmSetAreaForestType(forestID, "savannah forest");
				else rmSetAreaForestType(forestID, "mixed palm forest");
			}
			else if (diverseForest == 1) {
				if (diverseForestType == 0) {
					if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(forestID, "palm forest");
					else rmSetAreaForestType(forestID, "savannah forest");
				}
				else {
					if (rmRandFloat(0, 1) < 0.7) rmSetAreaForestType(forestID, "palm forest");
	...
	if (terrainChance == 0) rmPlaceObjectDefAtLoc(grassID, 0, 0.5, 0.5, 20 * cNumberNonGaiaPlayers);
	else if (terrainChance == 1) rmPlaceObjectDefAtLoc(grassID, 0, 0.5, 0.5, 10 * cNumberNonGaiaPlayers);

	int rockID = rmCreateObjectDef("rock");
	if (terrainChance == 0) rmAddObjectDefItem(rockID, "rock limestone sprite", 1, 1.0);
	else if (terrainChance == 1) rmAddObjectDefItem(rockID, "rock sandstone sprite", 1, 1.0);
	else rmAddObjectDefItem(rockID, "rock granite sprite", 1, 1.0);
	rmSetObjectDefMinDistance(rockID, 0.0);
	rmSetObjectDefMaxDistance(rockID, rmXFractionToMeters(0.5));
	rmAddObjectDefConstraint(rockID, avoidAll);
	rmAddObjectDefConstraint(rockID, avoidImpassableLand);
	if (terrainChance == 2) rmAddObjectDefConstraint(rockID, centerConstraint);
