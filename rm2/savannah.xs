...
void main() {
	...
	// RM X Setup.
	rmxInit("Savannah (ESO)", false, false, false);
	...
	if (rmRandFloat(0, 1) < 0.8) rmAddObjectDefItem(closeChickensID, "chicken", rmRandInt(6, 12), 5.0);
	else rmAddObjectDefItem(closeChickensID, "berry bush", rmRandInt(4, 8), 4.0);
	...
	else if (huntableNumber < 0.3) rmAddObjectDefItem(closeHuntableID, "zebra", rmRandInt(2, 3), 2.0);
	else if (huntableNumber < 0.6) rmAddObjectDefItem(closeHuntableID, "rhinocerous", 1, 2.0);
	else if (huntableNumber < 0.9) rmAddObjectDefItem(closeHuntableID, "rhinocerous", 2, 2.0);
	else if (huntableNumber < 1.0) rmAddObjectDefItem(closeHuntableID, "rhinocerous", 4, 2.0);
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(mediumDeerID, "gazelle", numHuntable, 4.0);
	else rmAddObjectDefItem(mediumDeerID, "giraffe", numHuntable, 4.0);
	...
	else rmAddObjectDefItem(farPredatorID, "hyena", 3, 4.0);
	...
	else if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntableID, "zebra", rmRandInt(4, 6), 2.0);
	else if (bonusChance < 0.9) rmAddObjectDefItem(bonusHuntableID, "giraffe", rmRandInt(3, 4), 2.0);
	else rmAddObjectDefItem(bonusHuntableID, "gazelle", rmRandInt(4, 7), 3.0);
	...
	if (bonusChance < 0.1) rmAddObjectDefItem(bonusHuntable2ID, "elephant", 3, 2.0);
	else if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntable2ID, "elephant", 2, 2.0);
	else if (bonusChance < 0.9) rmAddObjectDefItem(bonusHuntable2ID, "rhinocerous", 2, 2.0);
	else rmAddObjectDefItem(bonusHuntable2ID, "rhinocerous", 4, 4.0);
	...
	/*   for(i=0; <numTries)
   {
	...
	if (rmRandFloat(0, 1) < 0.75) id = rmAddFairLoc("Settlement", true, false, 70, 120, 60, 10);
	else id = rmAddFairLoc("Settlement", false, true, 60, 100, 40, 10);
	...
	// Berries.
	if (rmRandFloat(0, 1) < 0.6) rmPlaceObjectDefAtLoc(farBerriesID, 0, 0.5, 0.5, cNumberNonGaiaPlayers);
	...
	// Monkeys
	if (rmRandFloat(0, 1) < 0.5) rmPlaceObjectDefPerPlayer(farMonkeyID, false, 1);
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(deerID, "zebra", rmRandInt(1, 2), 1.0);
	else rmAddObjectDefItem(deerID, "giraffe", 1, 0.0);
	...
	if (rmRandFloat(0, 1) < 0.5) rmAddObjectDefItem(deer2ID, "rhinocerous", 1, 1.0);
	else rmAddObjectDefItem(deer2ID, "gazelle", 1, 0.0);
