...
void main() {
	...
	// RM X Setup.
	rmxInit("Vinlandsaga (ESO)", false, false, false);
	...
	if (predatorSpecies < 0.5) rmAddObjectDefItem(farPredatorID, "wolf", 2, 4.0);
	...
	if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntableID, "boar", 2, 2.0);
	else rmAddObjectDefItem(bonusHuntableID, "deer", 6, 2.0);
	...
	if (bonusChance < 0.5) rmAddObjectDefItem(bonusHuntableID2, "elk", 5, 2.0);
	else rmAddObjectDefItem(bonusHuntableID2, "elk", 7, 2.0);
