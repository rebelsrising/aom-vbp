...
void main() {
	...
	// RM X Setup.
	rmxInit("River Styx (ESO)", false, false, false);
	...
	if (cNumberPlayers < 5) centerAvoidance = 20;
	else centerAvoidance = 30;
	...
	rmPlaceObjectDefAtLoc(shoreStalagID, 0, 0.5, 0.5, 20 * cNumberNonGaiaPlayers);
