...
void main() {
	...
	// RM X Setup.
	rmxInit("Alfheim (ESO)", false, false, false);
	...
	if (rmRandFloat(0, 1) < 0.75) rmAddObjectDefItem(closeElkID, "elk", rmRandInt(3, 5), 4.0);
	else rmAddObjectDefItem(closeElkID, "elk", 2, 2.0);
	...
	if (predatorSpecies < 0.5) rmAddObjectDefItem(farPredatorID, "wolf", rmRandInt(2, 4), 4.0);
	else rmAddObjectDefItem(farPredatorID, "bear", 2, 4.0);
	...
	if (bonusChance < 0.33) rmAddObjectDefItem(bonusHuntableID, "elk", rmRandInt(2, 8), 4.0);
	else if (bonusChance < 0.66) rmAddObjectDefItem(bonusHuntableID, "caribou", rmRandInt(2, 6), 4.0);
	else rmAddObjectDefItem(bonusHuntableID, "aurochs", rmRandInt(2, 3), 4.0);
	...
	// Elk
	if (rmRandFloat(0, 1) < 0.9) rmPlaceObjectDefPerPlayer(closeElkID, false);
	else rmPlaceObjectDefPerPlayer(closeElkID, false, rmRandInt(3, 6));
